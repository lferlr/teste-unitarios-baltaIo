...
{
  private readonly Customer _customer = new Customer("Lucas Rodrigues", "lucas@balta.io");
  ...
  [TestMethod]
  [TestCategory("Domain")]
  public void Dado_um_novo_pedido_seu_status_deve_ser_aguardadndo_pagamento()
  {
    var order = new Order(_customer, 0, null);
  ...
  [TestMethod]
  [TestCategory("Domain")]
  public void Dado_um_pagamento_do_pedido_seu_status_deve_ser_aguardadndo_entrega()
  {
    var order = new Order(_customer, 0, null);
  ...
  [TestMethod]
  [TestCategory("Domain")]
  public void Dado_novo_item_sem_produto_o_mesmo_nao_deve_ser_adicionado()
  {
    var order = new Order(_customer, 0, null);
